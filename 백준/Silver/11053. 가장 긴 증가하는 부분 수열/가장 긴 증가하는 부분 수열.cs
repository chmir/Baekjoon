...
class Program
{
    ...
    {
        // 문제: bj11053 /s2 /가장 긴 증가하는 부분 수열 /240504
        // 이 문제는 수열 길이가 짧아서 2중포문으로 돌리는 dp방법( O(n^2) )도 된다는데,
        // 그렇게 중요한 방법은 아닌 거 같으니 이분탐색으로 돌리는 방법( O(nlogn) )을 알아보자
